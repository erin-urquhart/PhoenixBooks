    ...
    <?php endif ?>
      <div class="container">
		...
		<div class="jumbotron text-center" style="margin-bottom: 0">
			<h1>
				<a href="index.php">Phoenix Books - <?= $book_post['title'] ?></a>
			</h1>
		</div>
		<!-- END div id="header" -->
      ...
      <?php endif ?>
        ...
        <?php if (isset($_SESSION['user'])) :?>
          <?php if ($_SESSION['user']['user_type'] == 'admin') :?>
            <small> <a href="edit.php?id=<?= $book_post['id']?>">edit</a>
				</small>
          <?php endif ?>
        <?php endif ?>
      </h2>
        ...
        <div class="container">
				<form action="process_post.php" method="post">
					...
					<input type="hidden" name="user_id" id="user_id"
						...
						name="book_id" id="book_id" value="<?=$book_post['id']?>">
      ...
      <div class="container p-2 my-2 bg-light text-grey">
			<strong><?=$row_comment['username']?></strong> <small><?=$row_comment['date_created']?></small>
